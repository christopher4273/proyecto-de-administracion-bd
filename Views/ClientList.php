...
<body style="background-image: url(https://madariagamendoza.cl/wp-content/uploads/2019/01/fondo-gris.jpg); ">
    <div class="row">
        <div class="col-1"></div>
        <div class="col-10 mt-4 newSale " style="font-family: Segoe UI">
            ...
            <h1 class=" mt-3 mb-3">Lista Clientes</h1>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="?c=ClientController&a=edit" method="post">
                                <label>Id</label>
                                ...
                                <div class="mb-2">
                                    ...
                                    <button type="submit" name="save" class="btn btn-success save" href="ClientList.php">Guardar cambios</button>
                                </div>
                                </td>
                            </form>
                        </div>
