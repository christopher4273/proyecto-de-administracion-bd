...
<body style="background-image: url(https://madariagamendoza.cl/wp-content/uploads/2019/01/fondo-gris.jpg); ">
    <div class="row" style="font-family: Segoe UI">
        ...
        <div class="col-10 newSale mt-5">
            ...
            <h1 class=" mt-3 mb-3">Lista Categorias</h1>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="?c=CategoryController&a=edit" method="post">

                                <label for="exampleInputDescripcion" class="form-label">Codigo</label>
                                <input type="text" name="id_categoria" id="id_categoria" class="form-control" readonly />
                                ...
                                <div class="mb-2">
                                    <button type="button" name="cerrar" class="btn btn-danger">Cerrar</button>
                                    <button type="submit" name="save" class="btn btn-success" href="CategoryList.php">Guardar cambios</button>
                                </div>
                                </td>
                            </form>
                        </div>
    ...
    <script>
        $('.editbtn').on('click', function() {
            ...
            $('#id_categoria').val(datos[0]);
            $('#nom_categoria').val(datos[1]);
